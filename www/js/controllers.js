angular.module('app.controllers', []).controller('resultadosCtrl', function($scope, $location) {



}).controller('noticiasCtrl', function($scope) {}).controller('estadisticasHeroCtrl', function($scope, $http, $firebaseArray, $rootScope, $location) {
...
}).controller('calendarioCtrl', function($scope) {}).controller('equiposCtrl', function($scope) {
  ...
  var RefUser = new Firebase("https://livefutsal1.firebaseio.com/ResultadosMundial");
  $scope.todosResultados = $firebaseArray(RefUser);
  $scope.todosResultados.$loaded().then(function(dataResultados) {
     if (dataResultados.length) {
        $scope.resultadosAll = dataResultados;
  ...
  var RefNotiHero = new Firebase("https://livefutsal1.firebaseio.com/NoticiasMundial");
  $scope.todasNoticiasHero = $firebaseArray(RefNotiHero);
  $scope.todasNoticiasHero.$loaded().then(function(dataResultados) {
     if (dataResultados.length) {
        $scope.noticiasAll = dataResultados;
...
}).controller('equiposMundialCtrl', function($scope, $http, $firebaseArray, $rootScope) {
  var RefUser = new Firebase("https://livefutsal1.firebaseio.com/EquiposMundial");
  $scope.todosResultados = $firebaseArray(RefUser);
  $scope.todosResultados.$loaded().then(function(dataResultados) {
     if (dataResultados.length) {
        $scope.equipos = dataResultados;
...
}).controller('posicionesArgosCtrl', function($scope) {}).controller('posicionesMundialCtrl', function($scope) {
